...
package com.mulesoft.arc.arcdatastore.backend.arcSessions.model;

/**
 * Model definition for QueryResult.
 *
 * <p> This is the Java data model class that specifies how to parse/serialize into the JSON that is
 * transmitted over HTTP when working with the arcSessions. For a detailed explanation see:
...
public final class QueryResult extends com.google.api.client.json.GenericJson {
  ...
  private java.lang.Long sessions;
   ...
   */
  public QueryResult setEndDate(com.google.api.client.util.DateTime endDate) {
   ...
   * @return value or {@code null} for none
   */
  public java.lang.Long getSessions() {
    return sessions;
  }
   ...
   */
  public QueryResult setSessions(java.lang.Long sessions) {
   ...
   */
  public QueryResult setStartDate(com.google.api.client.util.DateTime startDate) {
   ...
   */
  public QueryResult setUsers(java.lang.Long users) {
    this.users = users;
    return this;
  }
